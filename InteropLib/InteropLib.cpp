...
extern "C" int __stdcall InteropAdd(int x, int y) {
	return x + y;
}

extern "C" void __declspec(dllexport) __stdcall InteropMatrixMul(float const* m1, float const* m2, float* o)
{
...
extern "C" void __declspec(dllexport) __stdcall InteropMatrixMulSSE2(float const* m1, float const* m2, float* out)
{
	__m128 r;
